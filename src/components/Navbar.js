...
const Navbar = () => {
  return (
    <nav className="w-full bg-material-200 shadow-md mb-2 p-2 flex justify-between items-center rounded-lg">
      <div className="text-3xl text-gray-300 font-extrabold drop-shadow-lg ml-4">
        Journeo
      </div>
